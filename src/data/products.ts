...
export const oilProducts: OilProduct[] = [
  ...
  },
  {
    ...
    stock: 'В наличии',
    image: '/img/oil-2.jpg',
    description: 'Синтетическое малозольное (Mid SAPS) моторное масло для круглогодичного использования в бензиновых и дизельных двигателях легковых автомобилей. Рекомендуется для современных дизельных двигателей с многоступенчатым катализатором и сажевым фильтром (DPF).',
    specifications: {
      api: 'SP',
      acea: 'C3', 
      temperature: '-35°C/+40°C'
  ...
  },
  {
    ...
    stock: 'В наличии',
    image: '/img/oil-3.jpg',
    description: 'Полусинтетическое моторное масло премиум-класса для бензиновых и дизельных двигателей.',
    specifications: {
      api: 'SN',
      acea: 'A3/B4',
  ...
  },
  {
    ...
    stock: 'В наличии',
    image: '/img/oil-4.jpg',
    description: 'Полностью синтетическое моторное масло с технологией PurePlus для максимальной защиты двигателя.',
    specifications: {
      api: 'SP',
      acea: 'A3/B3, A3/B4',
      temperature: '-35°C/+40°C'
