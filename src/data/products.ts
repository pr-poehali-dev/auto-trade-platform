export interface OilProduct {
  ...
  {
  id: 3758, // уникальный ID
  name: 'Top Tec 4600',
  brand: 'Liqui Moly',
  category: 'Синтетическое', // или 'Полусинтетическое', 'Минеральное'
  viscosity: '5W-30', // вязкость
  volume: '60л', // объем
  price: 77800, // цена в рублях (число)
  stock: 'В наличии', // или 'Мало', 'Под заказ'
  image: '/img/"C:\Users\corsi\OneDrive\Рабочий стол\Леша\Фото Ассортимента\LM\3758.jpg"',
  description: 'Синтетическое малозольное (Mid SAPS) моторное масло для круглогодичного использования в бензиновых и дизельных двигателях легковых автомобилей. Рекомендуется для современных дизельных двигателей с многоступенчатым катализатором и сажевым фильтром (DPF). Отлично подходит для использования в автомобилях, переоборудованных под использование природного и сжиженного газа (CNG/LPG).',
  specifications: {
    api: 'SP',
    acea: 'C2/C3', 
